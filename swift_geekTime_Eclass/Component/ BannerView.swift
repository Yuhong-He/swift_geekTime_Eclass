...
//
//  Created by Yuhong He on 11/10/2023.
//
...
class BannerView: UIView, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    static var converterViewTag = 10086
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let view = cell.contentView.viewWithTag(BannerView.converterViewTag) {
            ...
            newView.tag = BannerView.converterViewTag
